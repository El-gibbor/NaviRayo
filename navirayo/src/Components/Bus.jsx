        ...
        <div className="w-full h-full flex justify-between items-start gap-0 max-md:flex-col ">
          ...
          <div className="min-w-fit w-fit min-h-full max-md:pt-10 max-md:w-full border-border-lines-light pl-4 pb-2 max-md:pl-0  flex flex-col justify-end items-center">
            ...
            <button
              ...
              className="h-[40px] backdrop-blur-md w-[160px] mt-2 max-md:w-full px-2 bg-stone-200/50 dark:bg-container-dark-3 dark:hover:bg-container-dark-2 text-dark-text/60 dark:text-white font-semibold rounded-full text-sm flex items-center justify-center gap-1 cursor-pointer active:scale-95 "
            >
