            ...
            {searchBy === "location" ? (
              ...
              >
                ...
                <div className="h-full w-fit max-md:w-full relative">
                  ...
                  />
                  <div
                    className={`ring-1 ring-border-lines-light z-30 absolute top-[50px] p-1 w-full max-w-[240px] max-h-[200px] bg-white shadow-xl shadow-black/5  rounded-md overflow-clip flex flex-col ${inputFrom ? "visible " : "invisible"
                      }`}
                  >
                ...
                <div className="h-full w-fit max-md:w-full relative">
                  ...
                  />
                  <div
                    className={`ring-1 ring-border-lines-light z-30 absolute top-[50px] p-1 w-full max-w-[240px] max-h-[200px] bg-white shadow-xl shadow-black/5  rounded-md overflow-clip flex flex-col ${inputTo ? "visible " : "invisible"
                      }`}
                  >
                    <div className="scb p-1 w-full h-fit overflow-y-auto overscroll-contain">
                ...
                <div className="md:absolute left-[100%] py-2  flex h-full items-center justify-center max-md:w-full">
                  ...
                  <button
                    onClick={clearForm}
                    className={`h-full max-md:h-[40px] max-md:w-full  aspect-square bg-white cursor-pointer ring-0 ring-stone-200 ml-2 rounded-full flex items-center justify-center text-red-400 font-semibold text-sm tracking-tight active:scale-90 whitespace-nowrap gap-1 transition-all ease-in-out duration-300 ${formEmpty
                        ? "opacity-100"
              ...
              >
                ...
                <div className="h-full w-fit max-md:w-full relative">
                  ...
                  />
                  <div
                    className={`ring-1 ring-border-lines-light z-30 absolute top-[50px] p-1 w-full max-w-[260px] max-h-[200px] bg-white shadow-xl shadow-black/5  rounded-md overflow-clip flex flex-col ${dropDownRoute ? "visible " : "invisible"
                      }`}
                  >
                    <div className="scb p-1 w-full h-fit overflow-y-auto overscroll-contain">
                ...
                <div className="md:absolute left-[100%] py-2  flex h-full items-center justify-center max-md:w-full">
                  ...
                  <button
                    ...
                    className={`h-full max-md:h-[40px] max-md:w-full  aspect-square bg-white cursor-pointer ring-0 ring-stone-200 ml-2 rounded-full flex items-center justify-center text-red-400 font-semibold text-sm tracking-tight active:scale-90 whitespace-nowrap gap-1 transition-all ease-in-out duration-300 ${formEmptyRoute
                        ? "opacity-100"
                        : "md:opacity-0 md:pointer-events-none md:-z-10"
                      }`}
                  >
            ...
            <div className="w-fit h-fit flex items-center text-white gap-2 dark:text-white absolute bottom-5 left-5">
              <div className="min-h-[34px] z-10 w-fit flex p-1 bg-dark-text/30 dark:bg-light-text/30 backdrop-blur-sm rounded-full ">
                <button
                  ...
                  className={`text-xs font-semibold rounded-full py-1 px-3 transition-all ${searchBy === "location"
                ...
                <button
                  ...
                  className={`text-xs font-semibold rounded-full py-1 px-3 transition-all ${searchBy === "route"
                      ? "text-dark-text bg-white"
                      : "bg-transparent"
                    }`}
                >
