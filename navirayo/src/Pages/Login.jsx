    ...
    <div className="h-svh w-full overflow-x-clip overflow-y-auto flex items-center justify-between max-sm:justify-end p-8 max-sm:p-4 bg-white dark:bg-body-color-dark">
      ...
      <div className="fixed top-0 left-0 p-8 max-[250px]:bg-white w-full h-fit flex justify-end items-center select-none ">
        ...
        >
          {guestPending ? (
            ...
            <>
              <p className=" font-normal text-sm ">Continue as Guest</p>
              <GrFormNext />
            </>
          )}
        </button>
      ...
      <div className="w-full h-full flex flex-col items-center justify-center max-sm:justify-between max-sm:pt-[70px]">
          ...
          <form className="w-full pt-3 flex flex-col items-center justify-center gap-2">
            <div className="flex flex-col w-full items-start justify-start max-w-[350px]">
              ...
              <input
                type="text"
                name=""
                className="bg-[#F2F1F6] dark:bg-container-dark-2 text-dark-text dark:text-white text-sm rounded-sm h-[40px] w-full flex items-center justify-start px-5 outline-none focus:ring-2 ring-main-color ring-offset-2 dark:ring-offset-body-color-dark dark:placeholder:text-light-text"
            ...
            <div className="flex flex-col w-full items-start justify-start max-w-[350px]">
              ...
              <input
                type="password"
                id="password"
                className="bg-[#F2F1F6] dark:bg-container-dark-2 rounded-sm text-dark-text dark:text-white text-sm  h-[40px] w-full flex items-center justify-start px-5 outline-none focus:ring-2 ring-main-color ring-offset-2 dark:ring-offset-body-color-dark dark:placeholder:text-light-text"
        ...
        <div className="flex flex-col items-center justify-start w-full">
          <button
            // onClick={handleClick}
            className="bg-main-color my-4 outline-none text-white rounded-sm font-bold text-base transition active:scale-90 h-[40px] w-full max-w-[350px] flex items-center justify-center gap-2"
          >
            {pending ? (
              <>
                <CgSpinner className="animate-spinLoader text-2xl " />
